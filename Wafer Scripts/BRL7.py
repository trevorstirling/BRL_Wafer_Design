###########################################################################
# BRL7 Design Code (Called Double Sided Bragg Laser in Zareian Thesis)    #
# Solves for matching layer thicknesses to make the following structure   #
# phase matched. Created to reproduce BRL7 designed by Nima Zareian.      #
#                                                                         #
...
d_A_b = 200e-9             #Bottom A Layer (doped section) thickness
d_b = 10e-9                #Barrier thickness' (between quantum wells)
d_QW = 4.6e-9              #Quantum Well thickness
d_A_t = 200e-9             #Top A Layer (doped section) thickness
...
#PICS3D parameters
doping_substrate = -2e24   #Substrate doping [m^-3]
